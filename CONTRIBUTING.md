...
Please note we have a [code of conduct](https://github.com/phenax/react-test-render-fns/blob/master/CODE_OF_CONDUCT.md), please follow it in all your interactions with the project.
